...
class ScheduleOutboxLookupTests(unittest.TestCase):
    ...
    def test_multiday_event_clipped_to_query_window(self):
        # RFC 4791 §7.10: response periods must fall within the time-range.
        from datetime import datetime, timezone
        ...
        self._put_event(
            ...
            b"PRODID:-//Test//EN\r\n"
            b"BEGIN:VEVENT\r\n"
            b"UID:conf@example.com\r\n"
            b"DTSTAMP:20260101T000000Z\r\n"
            b"DTSTART:20260601T000000Z\r\n"
            b"DTEND:20260605T000000Z\r\n"
